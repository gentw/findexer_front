...
import Results from "@/layouts/main-layout/header/partials/search/Results.vue";
import Main from "@/layouts/main-layout/header/partials/search/Main.vue";
import Empty from "@/layouts/main-layout/header/partials/search/Empty.vue";
