<template>
  ...
  import TableHeadRow from "@/components/datatable/table-partials/table-content/table-head/TableHeadRow.vue";
  import TableBodyRow from "@/components/datatable/table-partials/table-content/table-body/TableBodyRow.vue";
